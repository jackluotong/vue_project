  ...
  data() {
    return {
      jsPart: [
        ...
        { name: "this 的理解？", answer: "全局上下文默认this指向window,箭头函数中捕获其所在上下文的 this 值，作为自己的 this 值,并且由于没有属于自己的this,而箭头函数是不会被new调用的" },
        ...
        { name: '设计模式有哪些？介绍一下工厂模式？', answer: '' },
        { name: '浏览器和服务器是怎么交互的？请求的时候返回什么？', answer: '' },
        { name: '箭头函数的this指向哪里？对象？函数', answer: '捕获其所在上下文的 this 值，作为自己的 this 值,并且由于没有属于自己的this,而箭头函数是不会被new调用的' },
